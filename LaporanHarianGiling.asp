    ...
    <p align="left">
      <div class="se-pre-con"></div>
		...
		<table class="table-fill" width="100%">
            <thead>
              <tr>
                <th colspan="6" class="text-left" width="5%"><div align="center">LAPORAN HARIAN GILING</div></th>
              </tr> 
              <tr>
                <th colspan="6" class="text-left" width="5%"><div align="left"> TANGGAL 
              ...
              <tr>
                ...
                <th><div align="center">Sat</div></th>
				<th><div align="center">Unit</div></th>
                <th><div align="center">H.I</div></th>
                <th><div align="center">S/D H.I</div></th>
              </tr>
            </thead> 
			<% 
              color="#EEEEEE"
			  while not rec.eof
			  If color = "#EEEEEE" Then color = "#FFFFFF" Else color = "#EEEEEE" 
            %> 			
            <tr bgcolor="<%=color%>">          
              <td rowspan="2"><div align="center"><%=i%></div></td>
              <td rowspan="2"><div><%=rec.fields ("uraian")%></div></td>
              <td rowspan="2"><div align="center"><%=rec.fields ("satuan")%></div></td>
			  <td>KB-I</td>
