...
'value = Request.QueryString("tgl")  
	...
	'membuat query'
						...
						Dim d_today
						d_today=Now
						tglcetak = Replace(Replace(Replace(d_today, "/", ""),":","")," ","")
						' String.Format("{yyyymmddhhmmss}",Now)
						...
						Response.Write(kdinsertspta)
						'response.write(kdspa)



	' 					'update kuota SPTA tblKuotaNoInduk
	' 					qinsert = "insert into tblkuotanoinduk (kdspa,tgl_entry) (select top 1 '" & kdinsertspta & "',getdate() as tgl_entry from m_ptnspta)"
