...
<body background="Images/body.png">
  ...
  <!-- Ends -->
      ...
      <table class="table-fill-judul" width="100%" border="0">
        <tr class="tr-judul">
        <th class="th-judul" width="200px">REALISASI PEMASUKAN</th>
        </tr>
      </table>
  ...
  PERINTAH =  "SELECT [KD],[afdeling],[HrIni],[Kemarin],[DuaHrKemarin],[SdHrIni] FROM vPemasukanTebuSKW_mobile WHERE (LEFT(KD, 1) <> '0') order by convert( int, kd )"
 set rec = server.CreateObject("ADODB.RECORDSET")
  ...
  <tr>
        ...
        <th class="text-left" width="5%" colspan="4"><div align="center">Pemasukan (Rit)</th>
      </tr>
      <tr>
