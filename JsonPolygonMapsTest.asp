...
'membuat query'
						...
						querytbl = "SELECT [inc],[id]+';'+[Fill]+';'+[StrokeColor] as id,[koordinat],[Fill],[StrokeColor]  FROM [SmartFarming].[dbo].[vPolygonMaps_Mobile] where  x between "&x&"-0.000995 and "&x&"+0.000995 and y between "&y&"-0.000995 and "&y&"+0.000995"

						querytbl = "SELECT [inc],[id]+';'+[Fill]+';'+[StrokeColor] as id,[koordinat],[Fill],[StrokeColor]  FROM [SmartFarming].[dbo].[vPolygonMaps_Mobile] where  id like '%30A0%' and id like '%bululawang%' or id like '%3B40%' and id like '%bululawang%' "
